...
select top (5) NOMBRE_EMPRESA, TIPO_SERVICIO, FECHA_FACTURA ,NUMERO_FACTURA,  sum (TOTAL_FACTURA*IVA_FACTURA) as Ingreso_Mes  
...
group by NOMBRE_EMPRESA, TIPO_SERVICIO, FECHA_FACTURA, NUMERO_FACTURA
